...
/*
 * @brief DHCP server example for W5500 EVB
 *
 * @note
...
#include "../../ioLibrary/Internet/DHCP/dhcps.h"
#include "../../ioLibrary/Internet/SNTP/sntps.h"
...
int main(void) {
  ...
  /* Network Initialization */
	...
	printf("\r\n=======================================\r\n");
	printf(" WIZnet %s EVB - DHCP / NTP Server v%d.%.2d\r\n", tmpstr, VER_H, VER_L);
	printf("=======================================\r\n");

	//Display_Net_Conf(); // handled by dhcp_run function
#endif

  dhcps_init(SOCK_DHCPs, gDATABUF);
  SNTPs_init(SOCK_SNTPs, gsntpDATABUF);
